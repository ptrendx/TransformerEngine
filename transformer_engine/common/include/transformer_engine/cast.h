 ...
 *         The type of quantized tensor in the output depends on the scaling mode of the output
 *         tensor. See file level comments.
 *         MXFP8 grouped tensors with a varying last dimension require the last dimension to be a
 *         multiple of 128. FP8 tensor-scaling grouped tensors use the logical grouped tensor size,
 *         so backing allocations may include padding past the logical tensor ranges.
 *
