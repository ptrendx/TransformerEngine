...
template <typename KernelParamsType>
NVTEShape TeNormalizationPlan<KernelParamsType>::getWorkspaceShape() const {
  ...
  return make_nvte_shape({workspace_size});
}
...
NVTEShape CudnnNormalizationPlan::getWorkspaceShape() const {
