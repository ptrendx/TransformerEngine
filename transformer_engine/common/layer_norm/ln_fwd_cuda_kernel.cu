...
REGISTER_FWD_TUNED_LAUNCHER(2560, bf16, bf16, fp8e4m3, fp32, 1, 4, 1, 16);
REGISTER_FWD_TUNED_LAUNCHER(3072, bf16, bf16, fp8e4m3, fp32, 1, 1, 4, 16);
REGISTER_FWD_TUNED_LAUNCHER(3584, bf16, bf16, fp8e4m3, fp32, 1, 1, 4, 8);
...
REGISTER_FWD_TUNED_LAUNCHER(2560, fp16, fp16, fp8e4m3, fp32, 1, 4, 1, 16);
REGISTER_FWD_TUNED_LAUNCHER(3072, fp16, fp16, fp8e4m3, fp32, 1, 1, 4, 16);
REGISTER_FWD_TUNED_LAUNCHER(3584, fp16, fp16, fp8e4m3, fp32, 1, 1, 4, 8);
...
REGISTER_FWD_TUNED_LAUNCHER(2560, fp32, fp32, fp8e4m3, fp32, 1, 4, 1, 16);
REGISTER_FWD_TUNED_LAUNCHER(3072, fp32, fp32, fp8e4m3, fp32, 1, 1, 4, 16);
REGISTER_FWD_TUNED_LAUNCHER(3584, fp32, fp32, fp8e4m3, fp32, 1, 1, 4, 8);
...
REGISTER_FWD_TUNED_LAUNCHER(2560, fp32, fp32, fp32, fp32, 1, 4, 1, 16);
REGISTER_FWD_TUNED_LAUNCHER(2560, fp16, fp16, fp16, fp32, 1, 4, 1, 16);
REGISTER_FWD_TUNED_LAUNCHER(2560, fp32, fp32, fp16, fp32, 1, 4, 1, 16);
REGISTER_FWD_TUNED_LAUNCHER(2560, bf16, bf16, bf16, fp32, 1, 4, 1, 16);
REGISTER_FWD_TUNED_LAUNCHER(2560, fp32, fp32, bf16, fp32, 1, 4, 1, 16);
...
REGISTER_FWD_TUNED_LAUNCHER(3584, fp32, fp32, fp32, fp32, 1, 1, 4, 16);
REGISTER_FWD_TUNED_LAUNCHER(3584, fp16, fp16, fp16, fp32, 1, 1, 4, 8);
REGISTER_FWD_TUNED_LAUNCHER(3584, fp32, fp32, fp16, fp32, 1, 1, 4, 16);
REGISTER_FWD_TUNED_LAUNCHER(3584, bf16, bf16, bf16, fp32, 1, 1, 4, 8);
REGISTER_FWD_TUNED_LAUNCHER(3584, fp32, fp32, bf16, fp32, 1, 1, 4, 16);
